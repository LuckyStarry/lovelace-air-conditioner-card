...
1. 将 `air-conditioner-card.js` 文件复制到 `www/air-conditioner-card/` 目录
2. 在 Home Assistant 配置中添加资源
...
2. 点击 "添加资源"
3. 选择 "JavaScript 模块"
4. 输入 URL: `/local/air-conditioner-card/air-conditioner-card.js`
5. 点击 "创建"
...
详细说明请查看 [DEPENDENCIES.md](DEPENDENCIES.md)
